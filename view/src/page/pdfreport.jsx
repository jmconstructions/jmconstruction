...
function PdfReport() {
  ...
  useEffect(() => {
    const fetchReportData = async () => {
      try {
        //mf 7
        const response = await axiosInstance.get(`/sitereport/${id}`);
  ...
  const downloadPDF = async () => {
    try {
      ...
      //
      // const response = await fetch(`/sitereport/report/${id}`, {
      //   method: "GET",
      // });
      ...
      //mf 8
      const response = await axiosInstance.get(`/sitereport/report/${id}`, {
